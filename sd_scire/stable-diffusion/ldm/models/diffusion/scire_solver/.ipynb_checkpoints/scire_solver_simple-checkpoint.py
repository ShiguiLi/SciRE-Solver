...
class SciRE_Solver:
    ...
    def singlestep_scire_solver_update(self, x, s, t, order, return_intermediate=False, solver_type='scire', r1=None, r2=None):
        ...
        """
        if order == 1:
            return self.scire_solver_first_update(x, s, t, return_intermediate=return_intermediate, method='singlestep_fixed')
        elif order == 2:
    ...
    def multistep_scire_solver_update(self, x, model_prev_list, t_prev_list, t, order, solver_type='scire'):

        if order == 1:
            return self.scire_solver_first_update(x, t_prev_list[-1], t, model_s=model_prev_list[-1], method='multistep')
        elif order == 2:
        ...
        with torch.no_grad():
            if method == 'adaptive':
                ...
                if method == 'singlestep':
                    ...
                    # print('timesteps_outer[0]=',timesteps_outer[0])
