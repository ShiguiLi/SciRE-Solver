...
class SciRESampler(object):
    def __init__(self, model, **kwargs):
        ...
        # self.noise_schedule = NoiseScheduleVP('linear', alphas_cumprod=self.alphas_cumprod)
# 
    ...
    def sample(self,
        ...
        scire_solver = SciRE_Solver(model_fn, self.noise_schedule, algorithm_type="scire", correcting_xt_fn=correcting_xt_fn)
    ...
    def encode(self,
        ...
        scire_solver = SciRE_Solver(model_fn, self.noise_schedule, algorithm_type="scire")
