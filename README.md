...
**The <em>SciRE-Solver</em> is a class of accelerating sampling algorithms specially tailored for diffusion models, requiring no training or optimization. Its numerical algorithm design is fundamentally predicated on the following recursive difference method.**
<p align="center">
...
<p align="center"><strong><a href="https://arxiv.org/abs/2211.01095">DPM-Solver++</a> with 2m (left) and 3m (right).</strong></p>
...
Samples by SciRE_V1_3 with singlestep (50 NFE) for this Disney prompt.
<p align="center">
  <img src="./assets/scirev13s_50_disney.png" width="100%">
</p>
