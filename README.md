...
**The <em>SciRE-Solver</em> is a class of accelerating sampling algorithms specially tailored for diffusion models, requiring no training or optimization. Its numerical algorithem design is fundamentally predicated on the following recursive difference method.**
<p align="center">
...
<p align="center"><strong>SciRE_v1_3s.</strong> </p>
